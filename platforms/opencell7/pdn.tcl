...
add_pdn_stripe -grid {grid} -layer {met1} -width {0.07600} -pitch {0.86200} -offset {0.00000} -followpins
add_pdn_stripe -grid {grid} -layer {met4} -width {0.25400} -pitch {4.29200} -offset {2.14600}
add_pdn_stripe -grid {grid} -layer {met5} -width {0.25400} -pitch {4.30200} -offset {2.15200}
...
define_pdn_grid -name {CORE_macro_grid_1} -voltage_domains {CORE} -macro \
  -orient {R0 R180 MX MY} -halo {0.3180 0.3180 0.3180 0.3180} -default -grid_over_boundary
...
define_pdn_grid -name {CORE_macro_grid_2} -voltage_domains {CORE} -macro \
  -orient {R90 R270 MXR90 MYR90} -halo {0.3180 0.3180 0.3180 0.3180} -default -grid_over_boundary
